package com.neonfunapps.scorekeeper.handball;
...
public class HandballActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sport_handball_activity);

        Toolbar mToolbar = findViewById(R.id.handball_toolbar);
        ...
        mButtonSet.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (input.length() == 0) {
                    Toast.makeText(HandballActivity.this, R.string.field_cant_be_empty, Toast.LENGTH_SHORT).show();
                } else if (input.equals("0")) {
                    Toast.makeText(HandballActivity.this, R.string.enter_positive_number, Toast.LENGTH_SHORT).show();
                } else {
    ...
    private void updateWatchInterface() {
        if (mTimerRunning) {
            ...
            Drawable img = HandballActivity.this.getResources().getDrawable(R.drawable.ic_pause_black_24dp);
            ...
            Drawable img = HandballActivity.this.getResources().getDrawable(R.drawable.ic_play_arrow_black_24dp);
            mButtonStartPause.setCompoundDrawablesWithIntrinsicBounds(img, null, null, null);
    ...
    private void closeKeyboard() {
        View view = HandballActivity.this.getCurrentFocus();
        if (view != null) {
            InputMethodManager imm = (InputMethodManager) HandballActivity.this.getSystemService(Context.INPUT_METHOD_SERVICE);
    ...
    public void onStop() {
        ...
        SharedPreferences prefs = HandballActivity.this.getSharedPreferences("prefs", Context.MODE_PRIVATE);
